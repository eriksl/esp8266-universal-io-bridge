...
OBJS			:= application.o config.o display.o http.o i2c.o i2c_sensor.o io.o io_gpio.o io_aux.o io_mcp.o queue.o stats.o uart.o user_main.o util.o
OTA_OBJ			:= rboot-bigflash.o rboot-api.o ota.o
HEADERS			:= application.h config.h display.h esp-uart-register.h http.h i2c.h \
					i2c_sensor.h io.h io_config.h io_gpio.h io_aux.h io_mcp.h io_shared.h ota.h queue.h stats.h uart.h user_config.h user_main.h util.h
