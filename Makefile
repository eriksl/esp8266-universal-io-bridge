...
OBJS			:= application.o config.o display.o display_saa.o http.o i2c.o i2c_sensor.o io.o io_gpio.o io_aux.o io_mcp.o io_pcf.o queue.o stats.o uart.o user_main.o util.o
OTA_OBJ			:= rboot-bigflash.o rboot-api.o ota.o
HEADERS			:= application.h config.h display.h display_saa.h esp-uart-register.h http.h i2c.h \
