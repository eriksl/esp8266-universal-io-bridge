...
irom attr_pure int sequencer_get_start(void)
{
	return(sequencer.start);
}

irom attr_pure int sequencer_get_current(void)
{
...
irom void sequencer_start(unsigned int start, unsigned int repeats)
{
